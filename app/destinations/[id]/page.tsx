  ...
  return (
    <main className="min-h-screen bg-[#0A1628]">
      ...
      <div className="relative h-[75vh] w-full overflow-hidden">
        ...
        <Link
          href="/destinations"
          className="absolute left-6 top-6 z-10 flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-white/75 transition-colors hover:text-[#D4A853]"
          style={{
